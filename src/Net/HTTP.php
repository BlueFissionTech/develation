...
class HTTP
{
     ...
     */
    public static function query($formdata, $numeric_prefix = '', $key = null)
    {
     ...
     */
    public static function domain($wholedomain = false)
    {
     ...
     */
    public static function href($href = '', $doc = true)
    {
        if (empty($href)) {
     ...
     */
    public static function cookie($var, $value = null, $expire = null, $path = null, $secure = false)
    {
        if (Val::isNull($value)) {
     ...
     * 								True on success, False otherwise.
     */
    public static function session($var, $value = null, $expire = null, $path = null, $secure = false)
    {
        if (Val::isNull($value)) {
     ...
     * @return void
     */
    public static function redirect($href = '', $request_r = [], $snapshot = '')
    {
        $href = HTTP::href($href);
