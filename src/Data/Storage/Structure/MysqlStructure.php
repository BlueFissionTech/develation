...
class MySQLStructure extends Structure
{
     ...
     */
    public const NUMERIC_FIELD = 'numeric';

    /**
     * Constant for decimal field type
     */
    public const DECIMAL_FIELD = 'decimal';

    /**
     * Constant for boolean field type
     */
    public const BOOLEAN_FIELD = 'boolean';

    /**
     * Constant for tinytext field type
     */
    public const TINYTEXT_FIELD = 'tinytext';
     ...
     */
    public const MEDIUMTEXT_FIELD = 'mediumtext';

    /**
     * Constant for longtext field type
     */
    public const LONGTEXT_FIELD = 'longtext';

    /**
     * Constant for json field type
     */
    public const JSON_FIELD = 'json';
