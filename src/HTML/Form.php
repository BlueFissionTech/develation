...
class Form
{
     ...
     * @return string
     */
    public static function dropdown($content_r, $query_r = '', $trunc = '', $fields = 2)
    {
        $field_name = '';
        $get_name = true;
        $content = '';
     ...
     */
    public static function field($type = '', $name = '', $label = '', $value = '', $required = false, $id = '', $readonly = false, $properties = '')
    {
        $output = '';
        $label_text = '';
     ...
     */
    public static function time($name = 'time', $label = 'Time', $value = '', $readonly = false)
    {
     ...
     */
    public static function open($action = '', $name = '', $method = '', $validate = true, $properties = '', $image_path = 'images/', $css_path = 'css/rte.css')
    {
        $output = '';
        $action = HTML::href($action);
        if (Val::isNull($method)) {
            $method = 'post';
        }
     ...
     */
    public static function draw($field_type_r = '', $active_field_r = '', $property_r = '')
    {
        $output = '';
        $required = '';
        $id = '';
     ...
     */
    public static function validation($field_name = '', $field_label = '', $criteria = '')
    {
        $output = '';
        $output .= '
		<script language="Javascript" type="text/javascript">
